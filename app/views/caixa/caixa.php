...
$campo9 = 'Inicial';
?>
<!-- Caixa: remove body interno porque a pagina principal ja possui body no layout global. -->
<div class="row my-3">
...
<!-- Caixa: tabela em bloco proprio para evitar HTML invalido com div dentro de small. -->
