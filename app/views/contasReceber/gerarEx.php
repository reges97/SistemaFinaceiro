...
$query = $stmt->gerarExcel();
  ...
  if (($query) and ($query->rowCount() != 0)) {
    ...
    $cabecalho = ['Agenda', 'Descricao', 'Cliente', 
    'Banco/Caixa', 'Documento', 'Conta', 'Despesas', 
	mb_convert_encoding('Emissão','ISO-8859-1', 'UTF-8'), 'Vencimento', 
	'Frequencia', 'Valor', 'Usuario', 
    'Tipo', 'Data_recor', 
	'Juros', 'Multa', 'Desconto', 'Subtotal', 'Data_baixa'];
