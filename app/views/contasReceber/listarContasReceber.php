...
$descricao = $cp1;
		...
		<a href="#" onclick="baixar('{$id}' , '{$cp1}', '{$cp9}', '{$valorj}', '{$cp3}','{$cp21}','{$cp20}','{$cp19}')" title="Dar Baixa">	<i class="bi bi-check-square text-success mx-1 {$ocutar}"></i> </a>
...
function baixar(id, descricao, valor, valorj, entrada, desconto, multa, juros){
    $('#id-baixar').val(id);
    $('#descricao-baixar').text(descricao);
    $('#valor-baixar').val(valor);
    $('#entrada-baixar').val(entrada);
     $('#subtotal').val(valorj);
