...
$query = $stmt->gerarExcel();
  ...
  if (($query) and ($query->rowCount() != 0)) {
    ...
    $cabecalho = [mb_convert_encoding('Numero lançamento','ISO-8859-1', 'UTF-8'), 
    'Tipo', 
    'Entrada',mb_convert_encoding('Saída','ISO-8859-1', 'UTF-8'), 'Movimento', 
    'Descricao', 'Valor', 'Usuário', 
    'Nome_usuário', 'Data', 'Lancamento', 'Plano_conta',
    'Nome_desp', 'Documento', 'Nome_fpg', 'Caixa_periodo', 
    'Conta_pag', 'Mov_contas', 'M.conta_rec', ];
