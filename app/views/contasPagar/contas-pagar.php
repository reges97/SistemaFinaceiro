...
$campo16 = 'Juros';
 ...
 <div class="col-md-12 container-fluid mb-4 mx-4">
		 ...
		 <a href="#" onclick="inserir()" type="button" class="btn btn-danger btn-sm text-white">Nova Agenda</a>
		 </div>
		 </small>
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="dados" role="tabpanel" aria-labelledby="home-tab">
							...
							<div class="row">
								<div class="col-md-4 col-sm-12">
									<div class="mb-3">
										<label for="exampleFormControlInput1" class="form-label">Plano de Contad</label>
										<select class="form-select" aria-label="Default select example" name="cat_despesas" id="cat_despesas" required>
							...
							<div class="row">
								...
								<!-- Avisos financeiros: opcoes gravadas na conta para vencimento e pagamento. -->
								<div class="col-12">
									<div class="row g-3 border-top pt-3 mt-1">
										...
										<div class="col-md-3">
											<div class="form-check">
												...
												<label class="form-check-label" for="aviso_baixa">Avisar pagamento</label>
											</div>
										</div>
										<div class="col-md-3">
...
<div class="modal fade" id="modalFotos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="false">
	<div class="modal-dialog modal-lg">
		...
		<form id="form-fotos" method="post">
			...
			<input type="hidden" class="form-control" name="id_contas"  id="id_contas">	
...
<!-- chama  Modal comprovantes -->
<div class="modal fade" id="modalComprovantes" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><span id="tituloModal">Lista Comprovantes</span></h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
...
<div class="modal fade" id="modalForm2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="form2" method="post" action="?router=ContasPagar/gerar "target="">
				<div class="modal-body">
				<div class="row">
				<div class="col-md-4 col-sm-12">
					<div class="mb-3">
